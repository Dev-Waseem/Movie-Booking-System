...
$fetch = "SELECT * FROM `movie_list` LIMIT {$start}, {$limit}";
      ...
      <div class="table-responsive">
        <table class="table table-hover">
          ...
          <tbody id="tab">
            ...
            ?>
              <tr>
                <td><strong><?php echo $row['mid'] ?></strong></td>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="update_movies_input.php?mid=<?php echo $row['mid']?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                      <a class="dropdown-item" href="movie_delete.php?mid=<?php echo $row['mid']?>"><i class="bx bx-trash me-1"></i> Delete</a>
                    </div>
                  </div>
                </td>
              </tr>
